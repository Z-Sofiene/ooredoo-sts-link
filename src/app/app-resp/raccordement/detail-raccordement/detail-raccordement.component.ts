...
@Component({
  selector: 'app-detail-raccordement',
  templateUrl: './detail-raccordement.component.html',
  styleUrl: './detail-raccordement.component.css'
})
export class DetailRaccordementComponent {
  @Input() zone: string | null = null;
  @Input() projet: string | null = null;
